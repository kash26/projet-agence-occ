                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('cities.update', $city->id) }}">
                            ...
                            <div class="row mb-3">
                                <label for="state_id" class="col-md-4 col-form-label text-md-end">{{ __('City') }}</label>

                                <div class="col-md-6">

                                    <select id="state_id" name="state_id" class="custom-select @error('state_id') is-invalid @enderror" value="{{ old('state_id') }}" required autocomplete="state_id" autofocus>
